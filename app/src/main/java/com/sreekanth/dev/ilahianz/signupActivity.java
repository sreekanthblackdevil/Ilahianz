    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUp_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Supports.Connected(signupActivity.this)) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    setUserInfo(SP_DISTRICT, "Not Provided");
                                    setUserInfo(SP_CITY, "Not Provided");
                                    setUserInfo(SP_DEPARTMENT, "BCA");
                                    setUserInfo(SP_BIO, "Not_Provided");
                            ...
                            reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isComplete()) {
                                        ...
                                        setUserInfo(SP_CITY, "Not Provided");
                                        setUserInfo(SP_DEPARTMENT, "BCA");
                                        setUserInfo(SP_BIO, "Not Provided");
